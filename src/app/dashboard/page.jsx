    ...
    <div className={styles.mainContainer}>
      <div className={styles.homeContainer}>
        <div className={styles.textContainer}>
          ...
          <h2 className={styles.subHeading}>Founder and CEO Of Xeven Solutions</h2>
          <p className={styles.quote}>
            <span className={styles.quotationMark}>&quot;</span> It&apos;s better to produce one <strong className={styles.emphasis}>leader</strong> than making thousands of <em className={styles.emphasis}>slaves</em>.<span className={styles.quotationMark}>&quot;</span>
          </p>
          <p className={styles.mainText}>
            Learning is an ongoing process, which should never stop. Whether you are a millionaire or running a successful business, learning must be the one constant that must stay with you. My personal story highlights the importance of these words. Due to my financial situation, I faced a lot of hurdles in my studies, but I never gave up. My journey began as a computer typist, and with time, I ventured into freelancing. Today, I am the CEO of a leading multinational tech company that generates millions of dollars every year, but my curiosity to learn more is still there. &quot;<span className={styles.mottoHighlight}>Rise &amp; Re-focus</span>&quot; is my life motto, which keeps me motivated to stay on track with my learning journey. The focus of this channel is to deliver quality content to inspire youth to keep pushing forward, guide them on the right career path, and keep them informed about emerging technologies.
          </p>
