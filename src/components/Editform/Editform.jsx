...
const Page = (props) => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setPath(`/dashboard/blog/${data._id}`);
        } else {
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <input value={title} type="text" placeholder="Title" className={styles.input} onChange={handleTitleChange} />
      <input
        type="file"
        name="file"
        id="file"
      ...
      <div className={styles.modelContainer}>
        <div className={styles.model}>
          <div className={styles.modelContent}>
            ...
            <p className={styles.modelText}>Only Admin Can Edit This Post</p>
